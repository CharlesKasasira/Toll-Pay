...
class DriversDetails extends StatefulWidget {
  var id;
  DriversDetails({Key? key, this.id}) : super(key: key);

  @override
  _DriversDetailsState createState() => _DriversDetailsState();
}

class _DriversDetailsState extends AuthRequiredState<DriversDetails> {
  String? _userId;
  String? _avatarUrl;
  String? username;
